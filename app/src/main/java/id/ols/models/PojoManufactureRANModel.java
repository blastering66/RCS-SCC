...
public class PojoManufactureRANModel {
    ...
    public class Datum {
         ...
         * The ranmodel_id
         */
        public void setRanmodelId(String ranmodelId) {
         ...
         * The ranmodel_name
         */
        public void setRanmodelName(String ranmodelName) {
         ...
         */
        public String getRanmodelIdmanufactur() {
         ...
         */
        public void setRanmodelIdmanufactur(String ranmodelIdmanufactur) {
